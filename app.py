    ...
    try:
        if key:
            ...
            if results:
                ...
                print(json.dumps({"isSuccess": False, "message": "No data returned from the query."}))
        elif file_path:
            ...
            if results:
                ...
                print(json.dumps({"isSuccess": False, "message": "No data to write to JSON file."}))
        else:
...
if __name__ == "__main__":
    try:
        ...
        file_path = sys.argv[5] if len(sys.argv) > 5 and sys.argv[5].endswith('.json') else None
